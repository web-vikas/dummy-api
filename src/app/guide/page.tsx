        ...
        <center>
          <div className="mt-12 items-end justify-end">
            ...
            <p className="my-2 text-xl">
              Step:1 is create account on dummy-api.com and <br />
            ...
            <p className="my-2 text-xl">
              ...
              your use <br />
              After <span className="text-red-700">Submit button</span> and
              click 3 dot and copy api link
            </p>
            <h1 className="mb-2 font-bold text-2xl my-10">
            ...
            />
            <p className="my-2 text-xl">
              After copy link go to token section and copy your token <br />
            ...
            <p className="my-2 text-xl">
              ...
              <span className="text-red-700">
                yourtoken&limit=10 or according you need
              </span>
            </p>
          </div>
        </center>
